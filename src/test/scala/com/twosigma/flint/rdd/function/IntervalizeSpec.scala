...
class IntervalizeSpec extends AnyFlatSpec with SharedSparkContext {
  ...
  "Intervalize" should "round correctly" in {
    ...
    assert(roundBeginBegin(2, clock).contains(2))
    assert(roundBeginBegin(3, clock).contains(2))
    assert(roundBeginBegin(4, clock).contains(4))
    assert(roundBeginBegin(5, clock).contains(4))
    ...
    assert(roundBeginEnd(2, clock).contains(4))
    assert(roundBeginEnd(3, clock).contains(4))
    assert(roundBeginEnd(4, clock).contains(6))
    assert(roundBeginEnd(5, clock).contains(6))
    ...
    assert(roundEndBegin(3, clock).contains(2))
    assert(roundEndBegin(4, clock).contains(2))
    assert(roundEndBegin(5, clock).contains(4))
    assert(roundEndBegin(6, clock).contains(4))
    ...
    assert(roundEndEnd(3, clock).contains(4))
    assert(roundEndEnd(4, clock).contains(4))
    assert(roundEndEnd(5, clock).contains(6))
    assert(roundEndEnd(6, clock).contains(6))
